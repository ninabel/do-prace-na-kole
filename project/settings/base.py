...
METABASE_DPNK_TEAM_REGULARITY_CITY_RESULTS_DATA_REPORT_URL = "{}{}".format(
    METABASE_APP_DOMAIN,
    os.getenv(
...
METABASE_DPNK_ORGANIZATION_COORDINATOR_RESULTS_DATA_REPORT_URL = "{}{}".format(
    METABASE_APP_DOMAIN,
    os.getenv(
        "METABASE_DPNK_ORGANIZATION_COORDINATOR_RESULTS_DATA_REPORT_URL",
        "",
    ),
)

METABASE_DPNK_CITY_COORDINATOR_RESULTS_DATA_REPORT_URL = "{}{}".format(
    METABASE_APP_DOMAIN,
    os.getenv(
        "METABASE_DPNK_CITY_COORDINATOR_RESULTS_DATA_REPORT_URL",
        "",
    ),
)
